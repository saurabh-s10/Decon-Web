...
class DialogBoxExisting extends StatelessWidget {
  @override
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            sh(36),
            Padding(
              padding: EdgeInsets.only(left: b * 55),
              child: Text(
                "Are you sure you want to change Existing Schedule?",
...
void dialogBoxExisting(BuildContext context) {
  showAnimatedDialog(
    context: context,
    barrierDismissible: true,
    builder: (BuildContext context) {
      return DialogBoxExisting();
    },
